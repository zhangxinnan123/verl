...
class TeacherModelManager:
    ...
    def __init__(
        ...
        if self.config.teacher_inference.free_cache_engine:
            self.sleep()

    def _initialize_llm_servers(self):
        teacher_world_size = self.config.teacher_inference.tensor_model_parallel_size
        world_size = (
        ...
        rollout_replica_class = get_rollout_replica_class(self.config.teacher_inference.name)
        rollout_config = self.config.teacher_inference
